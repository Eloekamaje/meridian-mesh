...
export function Carte({ titre, children, testid, action }) {
  return (
    <section className="rounded-xl border border-[#E5E5E3] bg-white p-4" data-testid={testid}>
...
export function ProduireSynthese({ cas, setCas }) {
...
// Objets structurés du travail — vivent dans l'Aperçu, pas dans la conversation
export default function ObjetsTravail({ cas, maj, setCas, situations }) {
