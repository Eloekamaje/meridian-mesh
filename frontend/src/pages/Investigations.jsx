    ...
    <div className="h-full overflow-y-auto px-8 py-8 pb-40" data-testid="investigations-page">
          ...
          return (
            <button
              ...
              className={`rounded-full border px-3 py-1.5 font-code text-[11px] transition-colors duration-200 ${
                actif ? "font-semibold" : "text-[#94A3B8] hover:text-[#F2F6F8]"
              }`}
              style={actif
      ...
      <div className="mt-6 grid grid-cols-1 gap-4 lg:grid-cols-2">
        {visibles.map((sit, idx) => {
          const n = NATURES[sit.nature] || { label: sit.nature || "—", couleur: "#7C93A8" };
          ...
          return (
            ...
            >
              ...
              <p className="mt-2 line-clamp-2 text-sm text-[#94A3B8]">{sit.resume}</p>
              ...
              <div className="mt-4 flex items-center gap-4 font-code text-[10px] text-[#7C93A8]">
      ...
      {visibles.length === 0 && (
        <p className="py-16 text-sm text-[#7C93A8]">Aucune investigation de ce type. Les découvertes de l'Observatoire alimentent cette page.</p>
      )}
    </div>
  );
}
